...
<head>
    ...
    <style>
        ...
        .welcome-banner { background: linear-gradient(135deg, var(--primary-dark), var(--primary-light)); border-radius: var(--border-radius); padding: 2rem; color: white; margin-bottom: 2rem; }
        .welcome-content { display: flex; justify-content: space-between; align-items: center; }
        .welcome-text h1 { font-size: 2rem; color: white; margin-bottom: 0.5rem; }
        .role-badge { display: flex; align-items: center; gap: 0.5rem; background: var(--accent-gold); color: var(--primary-dark); padding: 0.5rem 1rem; border-radius: 30px; font-weight: 700; font-size: 0.85rem; }
        .dashboard-grid { display: grid; grid-template-columns: 280px 1fr; gap: 2rem; }
        .profile-sidebar { background: white; border-radius: var(--border-radius); padding: 2rem 1.5rem; box-shadow: var(--shadow-md); text-align: center; height: fit-content; }
        ...
        .profile-name { font-size: 1.4rem; color: var(--primary-dark); margin-bottom: 0.25rem; font-weight: 700; }
        .profile-email { color: var(--text-muted); font-size: 0.85rem; margin-bottom: 1.5rem; }
        ...
        .menu-item { display: flex; align-items: center; gap: 1rem; padding: 0.85rem 1rem; border-radius: var(--border-radius-sm); color: var(--text-dark); text-decoration: none; transition: var(--transition-bounce); cursor: pointer; font-weight: 500; text-align: left; }
        .menu-item i { width: 20px; color: var(--text-muted); }
        .menu-item:hover { background: #f8fafc; transform: translateX(6px); }
        .menu-item:hover i { color: var(--accent-gold); }
        .menu-item.active { background: linear-gradient(135deg, #fef3c7, #fed7aa); color: var(--primary-dark); }
        .menu-item.active i { color: var(--accent-amber); }
        ...
        .stat-card { background: white; border-radius: var(--border-radius); padding: 1.5rem; display: flex; align-items: center; gap: 1rem; box-shadow: var(--shadow-md); transition: var(--transition-bounce); }
        .stat-icon { width: 60px; height: 60px; background: linear-gradient(135deg, #fef3c7, #fed7aa); border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 1.6rem; color: var(--accent-amber); }
        ...
        .section-title h2 { color: var(--primary-dark); font-size: 1.3rem; }
        
        .bookings-list { background: white; border-radius: var(--border-radius); overflow: hidden; box-shadow: var(--shadow-md); }
        .booking-item { display: flex; justify-content: space-between; align-items: center; padding: 1.2rem 1.8rem; border-bottom: 1px solid var(--border-light); }
        .booking-item:last-child { border-bottom: none; }
        .booking-info h4 { color: var(--primary-dark); margin-bottom: 0.4rem; font-size: 1.1rem; }
        .booking-info p { font-size: 0.85rem; color: var(--text-muted); display: flex; gap: 1rem; }
        .booking-status { display: inline-block; padding: 0.25rem 0.9rem; border-radius: 30px; font-size: 0.7rem; font-weight: 700; text-transform: uppercase; margin-top: 0.5rem; }
        .status-confirmed { background: #d1fae5; color: #065f46; }
        .status-pending { background: #fed7aa; color: #9a3412; }
        .status-completed { background: #dbeafe; color: #1e40af; }
        .status-cancelled { background: #fee2e2; color: #991b1b; }
        .booking-price { font-weight: 800; color: var(--accent-amber); font-size: 1.15rem; }
        
        .info-card { background: white; border-radius: var(--border-radius); padding: 2rem; box-shadow: var(--shadow-md); }
        .info-row { display: flex; padding: 1rem 0; border-bottom: 1px solid var(--border-light); }
        .info-row:last-of-type { border-bottom: none; }
        .info-label { width: 140px; font-weight: 600; color: var(--text-dark); }
        .info-value { color: var(--text-muted); flex: 1; }
        .edit-btn { background: linear-gradient(135deg, var(--accent-gold), var(--accent-amber)); color: var(--primary-dark); border: none; padding: 0.75rem 2rem; border-radius: 40px; font-weight: 700; cursor: pointer; display: inline-flex; align-items: center; gap: 0.5rem; margin-top: 1.5rem; }
        ...
        .modal-content { background: white; max-width: 500px; width: 90%; border-radius: var(--border-radius); padding: 2rem; }
        .modal-content label { display: block; font-size: 0.85rem; font-weight: 600; margin-top: 0.8rem; }
        .modal-content input { width: 100%; padding: 0.8rem; margin: 0.5rem 0; border: 1px solid var(--border-light); border-radius: 12px; font-size: 0.95rem; }
        .modal-buttons { display: flex; gap: 1rem; margin-top: 1.5rem; }
        .modal-buttons button { flex: 1; padding: 0.8rem; border-radius: 40px; border: none; cursor: pointer; font-weight: 600; }
        .toast { position: fixed; bottom: 30px; left: 50%; transform: translateX(-50%); background: #1e293b; color: white; padding: 0.8rem 2rem; border-radius: 50px; z-index: 2000; border-left: 5px solid var(--accent-gold); box-shadow: var(--shadow-lg); }

        .services-grid { display: grid; grid-template-columns: repeat(auto-fill, minmax(260px, 1fr)); gap: 1.5rem; padding: 1rem 0; }
        .service-card { background: white; border-radius: var(--border-radius); overflow: hidden; box-shadow: var(--shadow-sm); border: 1px solid var(--border-light); cursor: pointer; }
        .service-image { height: 170px; overflow: hidden; }
        .service-image img { width: 100%; height: 100%; object-fit: cover; }
        .service-info { padding: 1.2rem; }
        .service-info h4 { color: var(--primary-dark); font-size: 1.05rem; margin-bottom: 0.4rem; }
        .service-price { color: var(--accent-amber); font-weight: 800; }
    </style>
</head>
<body>
    <!-- Header Template -->
